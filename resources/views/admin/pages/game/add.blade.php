            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{Route('game_store')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="option[]" id="exampleInputName2"
                            placeholder="1st Option" required>
                        <input type="radio" name="correct_option" value="0" required> Correct
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName3">2nd Option</label>
                        <input type="text" class="form-control" name="option[]" id="exampleInputName3"
                            placeholder="2nd Option" required>
                        <input type="radio" name="correct_option" value="1" required> Correct
                    </div>
                    <div class="form-group">
                        <label for="exampleInputName4">3rd Option</label>
                        <input type="text" class="form-control" name="option[]" id="exampleInputName4"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="option[]" id="exampleInputName4"
                            placeholder="4th Option" required>
                                        ...
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{Route('game_delete', $data->id)}}">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
