			...
			<div class="row">
				<div class="col-md-4">
					<div class="intro-text-box text-box text-white">
						...
						<a href="#" class="read-more">Read More  <img src="{{asset('font_assets/img/icons/double-arrow.png')}}" alt="#"/></a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="intro-text-box text-box text-white">
				...
				<div class="col-xl-9 col-lg-8 col-md-7">
					...
					<div class="blog-item">
						<div class="blog-thumb">
							<img src="{{asset('font_assets/img/blog/1.jpg')}}" alt="">
						</div>
					...
					<div class="blog-item">
						<div class="blog-thumb">
							<img src="{{asset('font_assets/img/blog/2.jpg')}}" alt="">
						</div>
						<div class="blog-text text-box text-white">
							<div class="top-meta">11.11.18  /  in <a href="">Games</a></div>
							<h3>The best online game is out now!</h3>
					...
					<div class="blog-item">
						<div class="blog-thumb">
							<img src="{{asset('font_assets/img/blog/3.jpg')}}" alt="">
						</div>
						<div class="blog-text text-box text-white">
							<div class="top-meta">11.11.18  /  in <a href="">Games</a></div>
							<h3>The best online game is out now!</h3>
					...
					<div id="stickySidebar">
						<div class="widget-item">
							...
							<div class="trending-widget">
								<div class="tw-item">
									<div class="tw-thumb">
										<img src="{{asset('font_assets/img/blog-widget/1.jpg')}}" alt="#">
									</div>
									<div class="tw-text">
								...
								<div class="tw-item">
									<div class="tw-thumb">
										<img src="{{asset('font_assets/img/blog-widget/2.jpg')}}" alt="#">
									</div>
									<div class="tw-text">
										<div class="tw-meta">11.11.18  /  in <a href="">Games</a></div>
										<h5>The best online game is out now!</h5>
								...
								<div class="tw-item">
									<div class="tw-thumb">
										<img src="{{asset('font_assets/img/blog-widget/3.jpg')}}" alt="#">
									</div>
									<div class="tw-text">
										<div class="tw-meta">11.11.18  /  in <a href="">Games</a></div>
										<h5>The best online game is out now!</h5>
								...
								<div class="tw-item">
									<div class="tw-thumb">
										<img src="{{asset('font_assets/img/blog-widget/4.jpg')}}" alt="#">
									</div>
									<div class="tw-text">
										<div class="tw-meta">11.11.18  /  in <a href="">Games</a></div>
										<h5>The best online game is out now!</h5>
						...
						<div class="widget-item">
						<a href="#" class="add">
							<img src="{{asset('font_assets/img/add.jpg')}}" alt="">
						</a>
					</div>
					</div>
				</div>
...
<!-- video section end-->
	...
	<section class="featured-section">
		<div class="featured-bg set-bg" data-setbg="{{asset('font_assets/img/featured-bg.jpg')}}"></div>
	...
	<section class="newsletter-section">
		<div class="container">
			...
			<form class="newsletter-form">
				...
				<button class="site-btn">subscribe  <img src="{{asset('font_assets/img/icons/double-arrow.png')}}" alt="#"/></button>
			</form>
		</div>
	</section>
